...
- **Date**: 2026-05-07
- **決定者**: プロジェクトオーナー
- **関連**: [機能追加候補.md A-7](../../01_要件定義/機能追加候補.md#a-7-バックエンドログのファイル永続化)、[運用ガイド §5](../../04_環境構築/運用ガイド.md)、[セキュリティ設計書 §2-5 / §2-6](../../03_詳細設計/セキュリティ設計書.md)、[backend/utils/logger.py](../../../backend/utils/logger.py)
