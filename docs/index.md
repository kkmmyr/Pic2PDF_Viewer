...
- [OCR 設計書](03_詳細設計/機能別/OCR設計書.md)
- [hitomi 新着監視設計書](03_詳細設計/機能別/hitomi新着監視設計書.md)
- [小説 RAG バックエンド設計](03_詳細設計/機能別/小説テキスト検索・RAG機能_バックエンド設計.md)
- [小説 RAG フロントエンド設計](03_詳細設計/機能別/小説テキスト検索・RAG機能_フロントエンド設計.md)
...
- [ライセンス・コンプライアンス](04_環境構築/ライセンス・コンプライアンス.md)
...
- [リファクタリング履歴](99_アーカイブ/リファクタリング履歴.md) — 完了 Phase 1〜78 の詳細
