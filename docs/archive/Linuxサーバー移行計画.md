...
> **アーカイブ済み（2026-06-07）**: 移行は 2026-05-18 に完了済み。一部記述（`pdfs_compressed/` パス等）は現状と乖離している箇所がある。現行の運用手順は [docs/04_環境構築/サーバー連携よく利用するコマンド.md](../design/環境構築/サーバー連携よく利用するコマンド.md) を参照。
