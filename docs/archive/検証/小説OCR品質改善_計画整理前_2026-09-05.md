# 小説OCR品質改善 実装計画 — 計画整理前

> status: frozen | source: `docs/log/計画/小説OCR品質改善_実装計画.md` | moved: 2026-09-05
> previous status: active | last-verified: 2026-08-23 | owner: project owner

2026-09-05の計画整理前全文。現在の未完了作業は元計画を正本とし、本記録は変更しない。
...
過去の完了工程と実測値は
[OCR品質改善 技術知見](../../log/技術知見/OCR品質改善_技術知見.md)へ移した。
