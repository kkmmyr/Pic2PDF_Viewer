...
> status: frozen | archived: 2026-08-22 | Windows Task Scheduler 時代の初期決定。現行決定は [ADR-0004](../../design/基本設計/ADR/0004_hitomi-standalone-script.md) を参照

- **Status**: Accepted
- **Date**: 2026-04-29
- **決定者**: プロジェクトオーナー
- **関連**: [hitomi新着監視設計書](../../design/詳細設計/機能別/hitomi新着監視設計書.md)（本 ADR の元情報）
...
### ネガティブ・受容したコスト
- Task Scheduler の設定が手動セットアップ手順として残る（[RemoteControl Discord通知設定](../../design/環境構築/RemoteControl_Discord通知設定.md) 等で補完）
