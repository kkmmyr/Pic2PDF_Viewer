...
設計書から分離したrun 184の隔離・本番反映、Windows run 189・190、固定候補のscreeningは
[2026年8月の検証履歴](../../archive/検証/OCR候補評価・公開・Windows実測_2026-08.md)を参照する。
実測の時点と対象を保ち、過去の公開状態を現在の状態として扱わない。
