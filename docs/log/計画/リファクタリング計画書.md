...
> status: active | last-verified: 2026-09-19 | owner: project owner

最終更新: 2026-09-19（上下端候補46件の照合完了、表紙1件の欠けを残作業へ反映）

**現在地: N0〜N7c・TM-9・TM-11はmaster取り込みとLinux配備済み（TM-11はPR #25、b81b3a7）。通常停止と隔離実データでの復旧・再登録を確認済み。Windowsで指定ASIN B09P18GHW4の183画面を再撮影・登録し、通知除去と旧画像・メタの保全まで確認した。上下端候補46件の照合は完了し、45件一致・表紙1件の欠けを確認。表紙の修正・再撮影と全品質受入が残る。追加の物理移動は見送り、互換撤去は外部確認待ち。TM-8は環境待ち。**
...
撮影・登録・資産保全と通知除去の受入後、2026-09-19に上下端候補46件を全件照合した。
45件は元表示と一致したが、表紙001.pngの上下端に欠けがあり、全品質受入は未完了。
[品質候補照合記録](../../archive/検証/Kindle品質候補照合_B09P18GHW4_2026-09-19.md)へ判定を保存した。
修正事項は[既知の問題](../既知の問題.md#kindle-novel-cover-crop)を正本とし、警告の承認状態は変更していない。
...
上下端候補46件の照合は完了。次は[表紙の上下端欠け](../既知の問題.md#kindle-novel-cover-crop)の
原因確認・修正・実機再撮影を行い、欠けの解消と資産保全を確認してから全品質受入を判断する。
