...
- **Date**: 2026-04-29
- **決定者**: プロジェクトオーナー
- **関連**: [hitomi新着監視設計書.md §2](../../詳細設計/機能別/hitomi新着監視設計書.md)（本 ADR の元情報）
...
### ネガティブ・受容したコスト
- Task Scheduler の設定が手動セットアップ手順として残る（[RemoteControl_Discord通知設定.md](../../環境構築/RemoteControl_Discord通知設定.md) 等で補完）
