...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            { path: 'kindle/links', element: <KindleLinksPage />, errorElement: err },
            { path: 'kindle/capture', element: <KindleCapturePage />, errorElement: err },
            { path: 'kindle/imports', element: <KindleImportsPage />, errorElement: err },
            { path: 'kindle/price-watch', element: <KindlePriceWatchPage />, errorElement: err },
