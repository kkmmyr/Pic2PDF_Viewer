...
import { useKindleLinkCandidates, useKindleLinking } from '@/hooks/useKindleCatalog';
import type { KindleLinkCandidate } from '@/types/kindleCatalog';
import { errorMessage } from '@/utils/error';

export default function KindleLinksPage() {
