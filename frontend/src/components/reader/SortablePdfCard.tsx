...
export function SortablePdfCard(props: PdfCardProps) {
    ...
    const handle = (
        <button
            ...
            className="absolute top-2 right-2 z-card-badge p-1 rounded-full bg-white/90 dark:bg-gray-900/80 text-gray-500 dark:text-gray-300 hover:text-accent-600 dark:hover:text-accent-300 cursor-grab active:cursor-grabbing shadow"
            title="ドラッグして並べ替え"
