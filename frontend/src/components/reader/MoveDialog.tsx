...
export function MoveDialog({ open, onClose, onMove, currentSource }: MoveDialogProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 z-[100] flex items-center justify-center" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-xl w-full max-w-md flex flex-col max-h-[80vh] border border-gray-200 dark:border-gray-700">
                <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                    <h2 className="font-semibold text-lg text-gray-900 dark:text-gray-100">移動先を選択</h2>
                ...
                <div className="flex-1 overflow-y-auto p-2 min-h-[300px] bg-white dark:bg-gray-900">
                    {loading ? (
