---
description: 直近のコミットから docs/05_記録/変更履歴.md に追記する草稿を生成する
---

`docs/05_記録/変更履歴.md` への追記草稿を作成してください。Phase / 機能追加 / バグ修正 完了直後の運用想定。
...
3. **既存の変更履歴を Read**: `docs/05_記録/変更履歴.md`（無ければ新規作成を提案して確認を取る）
4. **草稿を組み立て**:
