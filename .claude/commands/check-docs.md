---
description: 設計書（要件定義/基本設計/詳細設計書[バックエンド編・フロントエンド編・フロントエンド_ファイルマップ・共通]/API仕様書）と実装の整合性をクロスチェックする
---
...
1. **詳細設計書_バックエンド編.md** と **詳細設計書_フロントエンド_ファイルマップ.md** を Read で読み込む（最初の1ステップ）。
